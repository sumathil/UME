...
void gradzatp(Ume::SOA_Idx::Mesh &mesh, DBLV_T const &zone_field,
  ...
  Kokkos::View<const Vec3 *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_point_normal(&point_normal[0], point_normal.size());
  Kokkos::View<const int *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> > h_c_to_z_map(&c_to_z_map[0], c_to_z_map.size());
  Kokkos::View<const int *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> > h_c_to_p_map(&c_to_p_map[0], c_to_p_map.size());
  Kokkos::View<const double *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_corner_volume(&corner_volume[0], corner_volume.size());
  Kokkos::View<double *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_point_volume(&point_volume[0], point_volume.size());
  Kokkos::View<Vec3 *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>> h_point_gradient(&point_gradient[0], point_gradient.size());
  Kokkos::View<const Vec3 *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_csurf(&csurf[0], csurf.size());
  Kokkos::View<const double *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>> h_zone_field(&zone_field[0], zone_field.size());
  Kokkos::View<const short *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_point_type(&point_type[0], point_type.size());
  Kokkos::View<const short *, KOKKOS_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged>>  h_corner_type(&corner_type[0], corner_type.size()); 
  ...
  /*for (int c = 0; c < cl; ++c) {
    ...
    std::cout<<point_volume[p]<<std::endl;
  }*/
